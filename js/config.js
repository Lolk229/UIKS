...
corridorNodes: {
  1: [
    // ДВЕРИ (тип door) — строго одна дверь на комнату / туалет / лестницу
    { id: "Door_Б1-1",   type: "door", room: "Б1-1",   coords: [300, 1060] },
    { id: "Door_Б1-2",   type: "door", room: "Б1-2",   coords: [320, 1040] },
    { id: "Door_Б1-3",   type: "door", room: "Б1-3",   coords: [300, 996] },
    { id: "Door_Б1-4",   type: "door", room: "Б1-4",   coords: [320, 980] },
    { id: "Door_Б1-5",   type: "door", room: "Б1-5",   coords: [300, 960] },
    { id: "Door_Б1-6",   type: "door", room: "Б1-6",   coords: [320, 920] },
    { id: "Door_Б1-7",   type: "door", room: "Б1-7",   coords: [300, 725] },
    { id: "Door_Б1-8",   type: "door", room: "Б1-8",   coords: [320, 880] },
    { id: "Door_Б1-9",   type: "door", room: "Б1-9",   coords: [300, 670] },
    { id: "Door_Б1-10",  type: "door", room: "Б1-10",  coords: [320, 805] },
    { id: "Door_Б1-11",  type: "door", room: "Б1-11",  coords: [300, 590] },
    { id: "Door_Б1-12",  type: "door", room: "Б1-12",  coords: [320, 765] },
    { id: "Door_Туалет1",type: "door", room: "Туалет", coords: [320, 675] },
    { id: "Door_S1",     type: "door", room: "S1",     coords: [320, 1075] },
    { id: "Door_S2",     type: "door", room: "S2",     coords: [310, 460] },

    // ОСЕВАЯ ЛИНИЯ КОРИДОРА (тип corridor) — координаты примерные, скорректируй под свой макет.
    // Горизонтальный участок (например верхний коридор). Ставь по центру ширины коридора.
    { id: "C1_h1", type: "corridor", coords: [310, 1070] },
    { id: "C1_h2", type: "corridor", coords: [310, 1020] },
    { id: "C1_h3", type: "corridor", coords: [310, 980] },
    { id: "C1_h4", type: "corridor", coords: [310, 930] },
    { id: "C1_h5", type: "corridor", coords: [310, 880] },
    { id: "C1_h6", type: "corridor", coords: [310, 830] },
    { id: "C1_h7", type: "corridor", coords: [310, 780] },
    { id: "C1_h8", type: "corridor", coords: [310, 730] },
    { id: "C1_h9", type: "corridor", coords: [310, 680] },
    { id: "C1_h10", type: "corridor", coords: [310, 630] },
    { id: "C1_h11", type: "corridor", coords: [310, 580] },
    { id: "C1_h12", type: "corridor", coords: [310, 530] },
    { id: "C1_h13", type: "corridor", coords: [310, 480] },


    // Поворот (узел на углу)
    { id: "C1_turn1", type: "corridor", coords: [325, 480] },

    // Вертикальный участок
    { id: "C1_v1", type: "corridor", coords: [350, 480] },
    { id: "C1_v2", type: "corridor", coords: [400, 480] },
    { id: "C1_v3", type: "corridor", coords: [450, 480] },
    { id: "C1_v4", type: "corridor", coords: [500, 480] },
    { id: "C1_v5", type: "corridor", coords: [550, 480] },

    // Если коридор продолжается — добавляй аналогично дальше
  ],
...
2: [
  ...
  // две двери к одному туалету — см. заметку ниже
  ...
  { id: "C2_h2", type: "corridor", coords: [310, 1020] },
  { id: "C2_h3", type: "corridor", coords: [310, 980] },
  { id: "C2_h4", type: "corridor", coords: [310, 930] },
  { id: "C2_h5", type: "corridor", coords: [310, 880] },
  { id: "C2_h6", type: "corridor", coords: [310, 830] },
  { id: "C2_h7", type: "corridor", coords: [310, 780] },
  { id: "C2_h8", type: "corridor", coords: [310, 730] },
  { id: "C2_h9", type: "corridor", coords: [310, 680] },
  { id: "C2_h10", type: "corridor", coords: [310, 630] },
  { id: "C2_h11", type: "corridor", coords: [310, 580] },
  { id: "C2_h12", type: "corridor", coords: [310, 530] },
  { id: "C2_h13", type: "corridor", coords: [310, 480] },

  // Поворот (узел на углу)
  { id: "C2_turn1", type: "corridor", coords: [325, 480] },

  // Вертикальный участок
  { id: "C2_v1", type: "corridor", coords: [350, 480] },
  { id: "C2_v2", type: "corridor", coords: [400, 480] },
  { id: "C2_v3", type: "corridor", coords: [450, 480] },
  { id: "C2_v4", type: "corridor", coords: [500, 480] },
  { id: "C2_v5", type: "corridor", coords: [550, 480] },
